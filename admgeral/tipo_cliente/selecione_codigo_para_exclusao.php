...
<p class="style2">Exclus&atilde;o de Status </p>
...
<form action="excluir.php" method="post" enctype="multipart/form-data" name="form1">
  ...
  <table width="100%"  border="0">
    ...
    <tr>
      ...
      <td width="35%">Selecione o c&oacute;digo. do status a ser exclu&iacute;do<br></td>
    ...
    $sql = "select * from tipos order by codigo";
