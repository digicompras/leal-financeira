...
<p class="style2">Altera&ccedil;&atilde;o de nome de Perfil. </p>
...
$sql = "select * from tipos where codigo = '$codigo'";
...
?>
        ...
        <tr>
          ...
          <td><input name="tipo" type="text" id="tipo" value="<? echo $linha[1]; ?>" size="50"></td>
