...
<table width="70%" border="0" align="center">
  <tr>
    <td width="13%">&nbsp;</td>
    <td width="21%">&nbsp;</td>
    <td width="34%"><form action="lojistas_exporta_excel_nome_cidade_telefones.php" method="post" name="form3" target="_blank">
      <span class="style22">
        <?
...
<input class='class01' type="submit" name="button" id="button" value="Exportar LOJISTAS para Excel - <? echo "$registrosdeclientesporperfil registros"; ?>">
    </form></td>
    <td width="17%">&nbsp;</td>
    <td width="15%">&nbsp;</td>
  </tr>
...
$reg++;
	$registrosdeclientesporperfil = mysql_num_rows($res2);
...
?>
    ...
    <div align="center"><span class="style1"><font color="#000000"><? echo $codigo; ?><br>
	<? echo $nfantasia; ?><br>
	<? echo $cnpj; ?></font><br>
    <? echo $email; ?> <br>     
...
echo "$proprietario - $celular - $email_representante   "; 
}
	
if($proprietario2==""){
}
else{
echo "$proprietario2 - $celular2 - $email_representante2 "; 
}
...
echo "$proprietario3 - $celular3 - $email_representante3  "; 
}
	
if($proprietario4==""){
}
else{
echo "$proprietario4 - $celular4 - $email_representante4  "; 
}
