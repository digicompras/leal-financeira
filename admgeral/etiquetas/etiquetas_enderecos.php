...
$imagemdefundo = $linha[1];
	
}
?>

<body bgcolor="#ffffff" background="background/<? echo "$imagemdefundo"?>">

<table width="70%" border="0" align="center">
  <tr>
    <td width="13%">&nbsp;</td>
    <td width="21%">&nbsp;</td>
    <td width="34%"><? echo "$tipo"; ?><form action="exporta_excel.php" method="post" name="form3" target="_blank">
      <span class="style22">
        <?
...
?>
         <tr> <td valign="middle"><span class="style23"> </span>  
