...
?>
    ...
    <tr> 
      ...
      <td><select name="funcao" id="funcao">
...
?>
    ...
    <tr> 
      ...
      <td width="34%"><input name="data_nasc" type="text" id="data_nasc" size="15" maxlength="10"></td>
...
Use o formato 00000-000</td>
    ...
    <tr>
      ...
      <input name="meta" type="text" id="meta"></td>
    </tr>
    ...
    <tr>
      ...
      <td><select name="horariologin" id="horariologin">
      ...
      <td><input name="vt" type="text" id="vt"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="horaslogin" type="text" id="horaslogin" size="3" maxlength="2"> 
        :
      <input name="minutoslogin" type="text" id="minutoslogin" size="3" maxlength="2"> 
      : 
      <input name="segundoslogin" type="text" id="segundoslogin" size="3" maxlength="2"></td>
    ...
    <tr>
      ...
      <td><select name="horas_diarias" id="horas_diarias">
        <option>6</option>
        <option selected>8.75</option>
      </select>
Horas Decimais</td>
    ...
    <tr>
      <td>Tempo de almo&ccedil;o</td>
      <td><input name="tempo_almoco" type="text" id="tempo_almoco" value="60" size="4" maxlength="2">
Em minutos</td>
    ...
    <tr>
      ...
      <td><select name="recebequinzena" id="recebequinzena">
...
?>
      ...
      <td align="left">Comiss&atilde;o</td>
