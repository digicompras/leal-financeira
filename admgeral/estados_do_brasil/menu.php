...
?>
    ...
    <tr>
      ...
      <td width="76%"><strong><font size="4">O que deseja fazer com os estados do Brasil?</font></strong></td>
...
?>
    ...
    <tr>
      ...
      <td><form name="form2" method="post" action="estado_insert.php">
        ...
        <input class='class01' type="submit" name="Submit2" value="Inserir estado ">
...
?>
    ...
    <tr>
      ...
      <td><form name="form3" method="post" action="selecione_codigo_estado_edicao.php">
        ...
        <input class='class01' type="submit" name="Submit3" value="Editar estado ">
...
?>
    ...
    <tr>
      ...
      <td><form name="form4" method="post" action="selecione_codigo_exclusao_estado.php">
        ...
        <input class='class01' type="submit" name="Submit4" value="Excluir estado ">
