...
?>
    ...
    <tr>
      ...
      <td width="76%"><strong><font color="#0000FF" size="4">O que deseja fazer com o  texto da mensagem do relatorio do operador?</font></strong></td>
...
?>
    ...
    <tr>
      ...
      <td><form name="form2" method="post" action="editar.php">
...
?>
    ...
    <tr>
      ...
      <td><form name="form3" method="post" action="exclusao.php">
