...
<form action="atualizar_tamanho_logo.php" method="post" enctype="multipart/form-data" name="form1">
  ...
  <table width="100%"  border="0">
    ...
    <tr>
      <td>&nbsp;</td>
      <td>Dimens&atilde;o padr&atilde;o 998 x 200 Px</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td width="24%"><input name="largura_logo" type="text" id="largura_logo"> 
      X 200 Px</td>
...
printf("<a href='http://www.allcredfinanceira.com.br/imagens/$linha[1]' target='_blank'><img src='../../imagens//$linha[1]' border='0' width='$linha[2]' height='$linha[3]'></a>"); 
