...
Pontua&ccedil;&atilde;o de Operadores
<form name="form1" method="post" action="../operadores/menu.php">
  <input type="submit" name="Submit21" value="Voltar">
  <span class="style1">
  <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
...
?>
          <input type="submit" name="Submit11" value="Lan&ccedil;amentos">
        </div>
      </form>
    </div></td>
    <td width="4%"><div align="center"></div></td>
...
?>
          <input type="submit" name="Submit8" value="Edi&ccedil;&atilde;o">
        </div>
      </form>
    </div></td>
...
?>
          <input type="submit" name="Submit15" value="Exclus&atilde;o">
        </div>
      </form>
    </div></td>
