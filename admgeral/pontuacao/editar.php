...
?>
    ...
    $sql = "select * from pontuacao where dia <> '' group by dia order by dia asc";
...
?>
    ...
    $sql = "select * from pontuacao where mes <> '' group by mes order by mes desc";
...
?>
    ...
    $sql = "select * from pontuacao where ano <> '' group by ano order by ano desc";
...
<select name="dia_final" id="select11">
  <?
    ...
    $sql = "select * from pontuacao group by dia order by dia desc";
...
<select name="mes_final" id="select12">
  <?
    ...
    $sql = "select * from pontuacao group by mes order by mes desc";
...
<select name="ano_final" id="select13">
  <?
    ...
    $sql = "select * from pontuacao group by ano order by ano desc";
...
?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="12%"><div align="center">Data dos Pontos</div></td>
      <td width="8%"><div align="center">Quant Pontos</div></td>
...
$sql = "SELECT * FROM pontuacao where nome = '$nome' and data between '$data_inicial' and '$data_final'";
...
$quant_pontos = $linha[5];

$nome = $linha[6];

$obs = $linha[7];

$tipo_dos_pontos = $linha[8];
...
?>
      ...
      <td><div align="center">
        <select name="tipo_dos_pontos" id="tipo_dos_pontos">
          <option selected><? echo $tipo_dos_pontos; ?></option>
          <option>+</option>
          <option>-</option>
        </select>
        <input name="quant_pontos" type="text" id="quant_pontos" value="<? echo $quant_pontos; ?>">
      </div></td>
      <td><div align="center">
