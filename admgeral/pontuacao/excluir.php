...
$comando = "delete from `pontuacao` where `pontuacao`. `codigo` = '$codigo_a_excluir' limit 1 ";



mysql_query($comando,$conexao) or die("Erro ao excluir os pontos do funcionario $nome"); 
...
<form name="form1" method="post" action="excluir.php">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="14%"><div align="center">Data dos Pontos</div></td>
      <td width="15%"><div align="center">Quant Pontos</div></td>
    </tr>
    <?
...
?>
      ...
      <td><div align="center"><? echo "$tipos_dos_pontos"; ?><? echo "$quant_pontos"; ?></div></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
