...
?>
    ...
    <td width="32%">      <form action="depto_pessoal/principal.php" method="post" name="form2">
...
?>
          <input type="submit" name="Submit15" value="RECIBO DE QUINZENA">
          </div>
    </form></td>
    <td width="11%">&nbsp;</td>
  </tr>
...
?>
          <input type="submit" name="Submit" value="Contribui&ccedil;&atilde;o Confederativa">
          </div>
    </form></td>
    <td><div align="center"></div></td>
    <td><div align="center">
...
?>
    ...
    <td><div align="center"></div></td>
    <td><form action="encerramento.php" method="post" name="form2" target="_blank">
      <div align="center">
        <?
...
?>
          <input type="submit" name="Submit2" value="Contribui&ccedil;&atilde;o Sindical">
          </div>
    </form></td>
    <td><div align="center"></div></td>
    <td><div align="center">
...
?>
    ...
    <td><div align="center"></div></td>
    <td><form action="horasextras/encerramento_horas_extras.php" method="post" name="form3" target="_blank">
      <div align="center">
        <?
...
?>
          ...
          <br>
          <input type="submit" name="button" id="button" value="HORAS EXTRAS - ENCERRAMENTO INDIVIDUAL">
        </div>
      </form>
    </div></td>
    <td>&nbsp;</td>
