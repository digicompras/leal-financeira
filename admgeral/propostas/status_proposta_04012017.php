...
?>
    ...
    <tr>
      ...
      <td><input name="vinculo" type="text" id="vinculo" value="<? echo $vinculo; ?>">
    ...
    <tr>
      ...
      <td><input name="percentual_comissao_avista" type="text" id="percentual_comissao_avista" value="<? echo $percentual_comissao_avista; ?>">
    ...
    <tr>
      <td>Comiss&atilde;o diferido</td>
      <td><input name="percentual_comissao_diferido" type="text" id="percentual_comissao_diferido" value="<? echo $percentual_comissao_diferido; ?>">
      <strong><font color="#0000FF"><font color="#0000FF"><strong>%</strong></font></font></strong></td>
      <td>Valor a Receber de comiss&atilde;o diferido</td>
      <td><input name="valor_a_receber_diferido" type="text" id="valor_a_receber_diferido" value="<? echo $valor_a_receber_diferido; ?>"></td>
    </tr>
    <tr>
