...
?>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">        
        ...
        <select name="estabelecimento_proposta" id="select8">
...
?>
      ...
      <td><strong><font color="#0000FF">        <? echo $status; ?>
        ...
        <input name="status_old" type="hidden" id="status_old" value="<? echo $status; ?>">

        <select name="status" id="select12">
...
?>
      ...
      <td><strong><font color="#0000FF">        
        ...
        <select name="tipo_proposta" id="select11">

          <option selected><? echo $tipo_proposta; ?></option>
...
?>
    ...
    <tr>
      ...
      <td><input name="parcela" type="text" id="parcela" value="<? echo $parcela; ?>"></td>
