...
<form name="form1" method="post" action="grava_editar_proposta_sem_alterar_datas.php">
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>Data Altera&ccedil;&atilde;o de Status</td>
      <td><select class="class02" name="dia_alteracao_status" id="dia_alteracao_status">
...
?>
        ...
        <select class="class02" name="ano_alteracao_status" id="ano_alteracao_status">
          <option selected><? echo $ano_alteracao_status;  ?></option>
          <?
...
?>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">
        <input name="dataproposta" type="hidden" id="dataproposta" value="<? echo $dataproposta;  ?>">
      <? echo $dataproposta; ?></font></strong> Hora proposta <strong><font color="#0000FF"><? echo $horaproposta; ?></font></strong></td>
    </tr>
...
?>
      ...
      <td><strong><font color="#0000FF"><? echo $status; ?>
        <input name="status_old" type="hidden" id="nome_operador5" value="<? echo $status; ?>">
        <select class="class02" name="status" id="select12">
...
?>
    ...
    <tr>
      ...
      <td><select class="class02" name="tabela" id="tabela">
...
?>
    ...
    <tr>
      ...
      <td><input class="class02" name="cpf" type="text" id="cpf2" value="<? echo $cpf; ?>" size="18" maxlength="14"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input class="class02" name="num_beneficio" type="text" id="num_beneficio" value="<? echo $num_beneficio; ?>"></td>
    ...
    <tr>
      ...
      <td><input class="class02" name="num_beneficio4" type="text" id="num_beneficio42" value="<? echo $num_beneficio4; ?>"></td>
    </tr>
    ...
    <tr>
      ...
      <td><strong>
        ...
        <input class="class02" name="data_nasc" type="text" id="data_nasc" value="<? echo $data_nasc; ?>" size="15" maxlength="10">

      </strong></td>

      <td>RG</td>

      <td><input class="class02" name="rg" type="text" id="rg" value="<? echo $rg; ?>" size="25" maxlength="25"></td>
    </tr>
    ...
    <tr> 
      ...
      <td width="31%"><input class="class02" name="orgao" type="text" id="orgao2" value="<? echo $orgao; ?>" size="15" maxlength="14"></td>

      <td width="21%">Emiss&atilde;o</td>

      <td width="33%">        <input class="class02" name="emissao" type="text" id="emissao" value="<? echo $emissao; ?>" size="15" maxlength="10">
    ...
    <tr>
      ...
      <td><input class="class02" name="pai" type="text" id="pai2" value="<? echo $pai; ?>" size="50" maxlength="50"></td>

      <td>M&atilde;e</td>

      <td><input class="class02" name="mae" type="text" id="mae" value="<? echo $mae; ?>" size="50" maxlength="50"></td>
    </tr>
    ...
    <tr> 
      ...
      <td><input class="class02" name="numero" type="text" id="numero" value="<? echo $numero; ?>" size="10" maxlength="10"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input class="class02" name="bairro" type="text" id="bairro2" value="<? echo $bairro; ?>" size="50" maxlength="50"></td>

      <td>Complemento</td>

      <td><input class="class02" name="complemento" type="text" id="complemento" value="<? echo $complemento; ?>" size="50" maxlength="50"></td>
    </tr>
...
?>
    ...
    <tr>
      ...
      <td><select class="class02" name="sexo" id="select3">
    ...
    <tr>
      ...
      <td><select class="class02" name="estadocivil" id="select5">
...
?>
    ...
    <tr>
      ...
      <td><input class="class02" name="celular" type="text" id="celular" value="<? echo $celular; ?>" size="15" maxlength="14"></td>

      <td>E-Mail</td>

      <td><input class="class02" name="email" type="text" id="email2" value="<? echo $email; ?>" size="50" maxlength="50"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input class="class02" name="valor_credito" type="text" id="valor_credito" value="<? echo $valor_credito; ?>">
    ...
    formato 0000.00(ponto) </td>
      ...
      <td> <font color="#0000FF">
        ...
        <input class="class02" name="valor_total" type="text" id="valor_total" value="<? echo $valor_total; ?>">
    ...
    <tr>
      ...
      <td><input class="class02" name="valor_liquido_cliente" type="text" id="valor_liquido_cliente" value="<? echo $valor_liquido_cliente; ?>"></td>
    ...
    <tr>
      ...
      <td><font color="#0000FF">
        ...
        <input class="class02" name="quant_parc" type="text" id="quant_parc" value="<? echo $quant_parc; ?>">
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">
        ...
        <select class="class02" name="banco_pagto" id="select2">
...
?>
      ...
      <td><strong><font color="#0000FF">
        ...
        <select class="class02" name="bco_operacao" id="select7">
...
?>
    ...
    <tr>
      ...
      <td><input class="class02" name="agencia" type="text" id="agencia2" value="<? echo $agencia; ?>"></td>

      <td>N&ordm; Conta</td>

      <td>      <input class="class02" name="conta" type="text" id="conta2" value="<? echo $conta; ?>"></td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        <div align="center">
          ...
          <input class="class02" name="banco1" type="text" id="banco1" value="<? echo $banco1; ?>" size="40">
      </div></td>
    ...
    <tr>
      ...
      <td><input class="class02" name="comissao_op" type="text" id="comissao_op" value="<? echo $comissao_op; ?>"></td>
      <td><strong>Valor a Receber </strong></td>
      <td><input class="class02" name="valor_a_receber" type="text" id="valor_a_receber" value="<? echo $valor_a_receber; ?>"></td>
    </tr>
    <tr>

      <td>Obs</td>

      <td><textarea class="class02" name="obs" cols="45" rows="7" id="obs"><? echo $obs; ?></textarea></td>

      <td colspan="2"><textarea class="class02" name="obs_propostas" cols="45" rows="7" readonly="readonly" id="obs_propostas"><?  
...
$reg=0;
    ...
    <tr>
      ...
      <td><textarea class="class02" name="obs2" cols="45" rows="7" id="obs2"><? echo $obs2; ?></textarea></td>
...
?>
        ...
        <input class="class01" type="submit" name="Submit" value="Alterar dados da Proposta"></td><td><div align="right"> </div></td>
