...
<p class="style2">Altera&ccedil;&atilde;o de nome de categoria de CLIENTES. </p>
...
$sql = "SELECT * FROM categorias_clientes where codigo = '$codigo'";
...
?></td>
        ...
        <tr>
          ...
          <td><input name="categoria" type="text" id="categoria" value="<? echo $linha[1]; ?>" size="70"></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="40">&nbsp;</td>
