...
<p class="style2">Selecione o c&oacute;digo da categoria de CLIENTE a ser alterada!</p>
...
<p>&nbsp;</p>
<form action="categoria.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="35%">Selecione o c&oacute;digo. da categoria a ser editada<br></td>
      <td width="25%"><select name="codigo" id="select4">
        <option value="null" selected>Selecione
        <?


    $sql = "select * from categorias_clientes order by codigo";
...
$sql = "select * from categorias_clientes order by categoria";
