...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      ...
      <td colspan="3"><strong><font color="#0000FF" size="4">Cadastro 
        ...
        de estabelecimentos!. </font></strong></td>
...
?>
    ...
    <tr>
      ...
      <td rowspan="2"><textarea name="obs" cols="50" rows="7" id="obs"></textarea></td>
...
?>
        ...
        <input type="submit" name="Submit" value="Cadastrar Estabelecimento"> 
