...
<form name="form1" method="post" action="grava_editar_estabelecimento.php">
  ...
  <table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td colspan="3"><strong><font color="#0000FF" size="4">Tela de altera&ccedil;&atilde;o do cadastro de estabelecimentos!. </font></strong></td>
...
?>
    ...
    <tr>
      ...
      <td width="36%"> <font color="#0000FF">
        ...
        <input name="nfantasia" type="text" id="data_nasc2" value="<? echo $nfantasia; ?>">
        <input name="nfantasia_old" type="hidden" id="nfantasia_old" value="<? echo $nfantasia; ?>">
      </font></td>
...
?>
    ...
    <tr>
      ...
      <td rowspan="2"><textarea name="obs" cols="50" rows="7" id="obs"><? echo $obs; ?></textarea></td>

      <td>Aparecer  no site?</td>
      <td><select name="aparecer_site" id="aparecer_site">
    ...
    <tr>
      <td>Qual posi&ccedil;&atilde;o</td>
      <td><input name="posicao" type="text" id="posicao" value="<? echo $posicao; ?>" size="4"></td>
    </tr>

    <tr>
      <td>Status</td>
      <td><select name="status" id="estado">
