...
?>
    ...
    <tr>
      ...
      <td><form action="../../bco_operacao/fechamento_bancos.php" method="post" name="form2">
        <input type="submit" name="Submit4" value="Fechamento TESTE(n&atilde;o liberado para produ&ccedil;&atilde;o)">
