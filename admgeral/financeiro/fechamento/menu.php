...
$total_do_periodo = $linha['total_periodo'];
        ...
        <tr>
          ...
          <td width="6%">Port. Gov.</td>
          <td width="6%">Novo INSS</td>
          <td width="6%">Refin INSS</td>
          <td width="7%">Port INSS</td>
          <td width="7%">Cart&atilde;o</td>
          <td width="7%">Cart&atilde;o Saque</td>
          <td width="5%">Seguro</td>
          <td width="6%">Aumento</td>
          <td width="4%">CP</td>
          <td width="8%">Veiculos</td>
          <td width="8%">Saldo de Gov</td>
          <td width="9%">Slado de INSS</td>
          <td width="9%">Fisico</td>
        </tr>
        <?
...
$total_do_periodo = $linha['total_periodo'];
          ...
          <td valign="middle"><span class="style3">
            <?
$sql = "select sum(saldodegov) as total_periodo from fechamento_bancos where data between '$data_inicial' and '$data_final'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
...
$total_do_periodo = $linha['total_periodo'];
          ...
          <td valign="middle"><span class="style3">
            <?
$sql = "select sum(saldodeinss) as total_periodo from fechamento_bancos where data between '$data_inicial' and '$data_final'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
...
$total_do_periodo = $linha['total_periodo'];
          ...
          <td valign="middle"><span class="style3">
            <?
$sql = "select sum(fisico) as total_periodo from fechamento_bancos where data between '$data_inicial' and '$data_final'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
