...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      ...
      <input name="banco" type="hidden" id="banco" value="<? echo $banco; ?>">

      <input name="agencia" type="hidden" id="agencia" value="<? echo $agencia; ?>">

      <input name="conta" type="hidden" id="conta" value="<? echo $conta; ?>">

      <input name="num_beneficio" type="hidden" id="num_beneficio" value="<? echo $num_beneficio; ?>"></td>
