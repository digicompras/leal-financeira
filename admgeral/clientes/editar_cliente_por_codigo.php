...
?>
    ...
    <tr> 
      ...
      <td width="22%">Senha do Servidor</td>
      <td width="23%"><font color="#0000FF">
...
?>
    ...
    <tr>
      <td colspan="2">&nbsp;</td>
      <td>Valor Renda</td>
      <td><input name="valorrenda" type="text" id="valorrenda" value="<? echo $valorrenda; ?>"></td>
    </tr>
    <tr>
...
?>
        ...
        <table width="100%" border="0" align="center">
          <tr>
            ...
            <td width="14%">Data / Hora da resposta: </td>
...
$sql = "SELECT * FROM admgeral where usuario = '$usuario' and senha = '$senha' and status = 'Ativo'";
