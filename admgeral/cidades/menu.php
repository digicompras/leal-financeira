...
?>
    ...
    <tr>
      ...
      <td width="76%"><strong><font size="4">O que deseja fazer com as cidades do Brasil?</font></strong></td>
...
?>
    ...
    <tr>
      ...
      <td><form name="form2" method="post" action="inserir.php">
        ...
        <input class='class01' type="submit" name="Submit2" value="Inserir Cidade">
...
?>
    ...
    <tr>
      ...
      <td><form name="form3" method="post" action="selecione_codigo_para_edicao.php">
        ...
        <input class='class01' type="submit" name="Submit3" value="Editar Cidade">
...
?>
    ...
    <tr>
      ...
      <td><form name="form4" method="post" action="selecione_codigo_exclusao.php">
        ...
        <input class='class01' type="submit" name="Submit4" value="Excluir Cidade">
