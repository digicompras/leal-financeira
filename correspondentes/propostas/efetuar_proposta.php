...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      <td width="15%">Nome</td>
      <td width="37%"><input name="nome" type="text" id="nome" value="<? echo $nome_cli; ?>" size="50" maxlength="50"></td>
      <td width="11%">CPF</td>
      <td width="36%"><input name="cpf" type="text" id="cpf2" value="<? echo $cpf; ?>" size="18" maxlength="14"></td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      ...
      <td><input name="valor_credito" type="text" id="valor_credito">
