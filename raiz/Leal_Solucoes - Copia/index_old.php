...
echo "<img src='images/$imagem' border='0' width='800' height='620' alt='$texto'>"; 
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html"><img width="180" height="90" src="images/logo.jpg" alt="company logo" /></a>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li><a href="../login_operador.php?instrucao=funcionario">Area do Operador</a></li>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="text-center"><h3>Soluções financeiras</h3></div>

							</div>

						</div>

						<h4>Um novo conceito de solução financeira com atendimento personalizado</h4>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="text-center"><h3>Está sem tempo?</h3></div>

							</div>

						</div>

						<h4>Iremos até você</h4>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="text-center"><h3>Sem burocracia!</h3></div>

							</div>

						</div>

						<h4>Crédito fácil com as melhores taxas de mercado</h4>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="text-center"><h3>Grandes parcerias</h3></div>

							</div>

						</div>

						<h4>Trabalhamos como correspondente bancário</h4>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="text-center"><h3>Aposentados e pensionistas</h3></div>

							</div>

						</div>

						<h4>Crédito para aposentados, pensionistas e governo em geral</h4>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="text-center"><h3>Crédito pessoal</h3></div>

							</div>

						</div>

						<h4>Ganhe fôlego para enfrentar a crise</h4>
						...
						<div class="text-center">
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									Uma empresa voltada a assessoria financeira disponibilizando vários serviços, tais como: crédito consignado para aposentados, pensionistas do INSS e servidores públicos em geral. Crédito pessoal no cheque, carnê e cartão de crédito. Emissão de cartões de crédito bandeira visa e master. Seguros em geral. Financiamento e refinanciamento de carros, motos e caminhões.

									Nossa missão é prezar por um bom atendimento com objetividade, honestidade e acima de tudo, fornecer a solução ideal para o seu caso.

									Também trabalhamos como correspondente bancário de vários bancos, tais como: Bradesco, Daycoval, Itaú, Pan, Bonsucesso, BGN, Safra, BV financeira e OMNI financeira.
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<img width="340" height="280" src="images/fachada.jpg">

									<img width="340" height="280" src="images/office.jpg">
		...
		<section id="services">
			...
			<div class="orangeback">
				...
				<div class="container">
					...
					<div class="text-center homeport2"><h2>Serviços</h2></div>
						...
						<div class="col-md-12 homeservices1">
							...
							<div class="col-md-3 portfolio-item">
								...
								<div class="text-center">
									...
									<h3><a href="#contact">Aposentados e pensionistas</a></h3>

									<p>Aposentado, pensionista e servidor público, solicite seu crédito consignado. É rápido, prático e sem burocracia.</p>									
							...
							<div class="col-md-3 portfolio-item">
								...
								<div class="text-center">
									...
									<h3><a href="#contact">Crédito<br> pessoal</a></h3>

									<p>Saia da crise, solicite seu crédito pessoal e realize seus sonhos.</p>
							...
							<div class="col-md-3 portfolio-item">
								...
								<div class="text-center">
									...
									<a href="#contact"><img width="140" height="150" src="images/car.png"></a>

									<h3><a href="#contact">Financiamento e refinanciamento</a></h3>

									<p>Crédito para financiar ou refinanciar carros, motos e caminhões.</p>
							...
							<div class="col-md-3 portfolio-item">
								...
								<div class="text-center">
									...
									<h3><a href="#contact">Cartões de<br> crédito</a></h3>

									<p>Cartão de crédito consignado, sem anuidade, sem consulta ao SPC/Serasa e cartão internacional.</p>
				...
				<div class="row">
					...
					<div class="col-md-offset-1 col-md-10">
						...
						<div class="text-center">
							...
							<h2>"Minha vida toda trabalhei com amor ao que faço e por isso resolvi montar a minha empresa focando sempre em um atendimento diferenciado, hoje nossa população necessita de um atendimento personalizado, com dedicação e acima de tudo com honestidade"</h2>
							...
							<div class="row">
								...
								<div class="col-md-12 height-contact-element">
									...
									<div class="form-group">
										...
										<span class="text">Rua Francisco Marques, 1099 - Franca -SP</span>
								...
								<div class="col-md-12 height-contact-element">
									...
									<div class="form-group">
										...
										<span class="text">+51 (16) 3409-5731</span>
								...
								<div class="col-md-12 height-contact-element">    
									...
									<div class="form-group">
										...
										<span class="text"><a href="malito:mail@demolink.org">lealfinanceira@outlook.com</a></span>
			...
			<div class="container"> 
				...
				<div class="text-center height-contact-element">
					...
					<ul class="list-unstyled list-inline list-social-icons">
						...
						<li class="active"><a target="_blank" href="https://www.facebook.com/Leal-Solu%C3%A7%C3%B5es-Financeiras-529238700581953/?fref=ts"><i class="fa fa-facebook social-icons"></i></a></li>
