			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li class="active1"><a href="#about"><? echo "$item2"; ?></a></li>

						<li class="active1"><a href="#services"><? echo "$item3"; ?></a></li>

						<li class="active1"><a href="#contact"><? echo "$item4"; ?></a></li>
						
						<li class="active1"><a href="../login_operador.php?instrucao=funcionario"><? echo "$item5"; ?></a></li>

						<li class="active1"><a href="cadastra_parceiros/inserir_operador.php" target="_blank"><? echo "$item6"; ?></a></li>
...
<br><br><br><br><br><br>
<br>
						  <h1 class="quem_somoSs">Quem somos</h1>
						  <img class="img-responsive displayed" src="images/short.png" alt="Company about"/>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<img class="ima" width="400" height="280" src="images/<? echo "$imagem7"; ?>">

									<img class="ima2" width="400" height="280" src="images/<? echo "$imagem8"; ?>"><br>
									
									<table width="100%" class="bloc_1">
										<tr width="100%">
											<td width="50%" class="bloc_text1" align="center"><? echo "$texto1_da_img7 "; ?> </td>
											<!--<td width="30%" align="center"></td>-->
											<td width="50%" class="bloc_text2" align="center" valign="top"><? echo "$texto1_da_img8 "; ?> </td>
										</tr>
										<!--<tr width="100%">
			...
			<div class="container"> 
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="col-lg-5 col-md-8 contatos0">
						...
						<div class="col-lg-6 col-md-3 contatos1">

							<div class="row">

								<div class="col-md-6 height-contact-element">

									<div class="form-group">
									<a href="https://goo.gl/maps/agK7ZqAGUj51MVV89" class="https-map">
								...
								<div class="col-md-12 height-contact-element">
									...
									<div class="form-group whatsapp1">
										<i class="fa fa-2x fa-phone"></i>
										<span class="text"><img src='images/whatsapp.png' border='0' width='30'><? echo "<a href='https://wa.me/551634095731' target='_blank'>+51 (16) 3409-5731</a>"; ?></span>
										<i class="fa fa-2x fa-phone"></i>
										<span class="text"><img src='images/whatsapp.png' border='0' width='30'><? echo "<a href='https://wa.me/5516993691349' target='_blank'>+51 (16) 99369-1349</a>"; ?></span><br><br>
										<i class="fa fa-2x fa-phone"></i>
										<span class="text">(16) 99204-9280</span>
									</div>
...
<br>
				      ...
				      <table width="100%" border="0" align="center">
				        <tbody>
							...
							echo "<li>
							<a target='_blank' href='https://www.facebook.com/Leal-Solu%C3%A7%C3%B5es-Financeiras-529238700581953/?fref=ts'><img width='30' src='./images/facebook-13(1).png''></a>	";
				          ...
				          <tr>
				            <td width="25%" align="right" valign="top"><a href="index.php#aviso_de_filiais"><img width="180" height="90" src="images/logo.jpg" alt="company logo" /></a></td>
	      ...
	      <tbody>
	        <tr>
	          <td scope="col"><div id="aviso_de_filiais" class="modal_de_aviso" role="dialog" align="center">
				...
				<p class="img_fechar">
					<img class="img_fechar1" src='images/aviso_de_filiais.jpeg' border='0' width='400'></a>";
				</p>
                </p>
	            </div></td>
	          <td scope="col">&nbsp;</td>
