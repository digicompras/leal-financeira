...
window.location = 'informacoes_antecedem_efetuar_proposta.php?tipo=$tipo&estabelecimento_proposta=$estabelecimento_proposta&cpf=$cpf&tipo_proposta=$tipo_proposta&tipo_contrato=$tipo_contrato&tabela=$tabela';
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td><input name="emissao" type="text" id="emissao" value="<? echo $emissao_cli; ?>" size="15" maxlength="10"></td>
    </tr>
    <tr>
      <td>Pai</td>
...
?>
    ...
    <tr> 
      <td width="15%"><strong>Cr&eacute;dito Solicitado R$</strong> </td>
...
echo $termo;
?>
        <input name="termo" type="hidden" id="termo" value="<? echo $termo;  ?>"></td>
    </tr>
    <tr>
