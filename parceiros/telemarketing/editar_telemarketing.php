...
$comando = "update `$linha[1]`.`telemarketing` set `codigo` = '$codigo',`dia_abertura` = '$dia_abertura',`mes_abertura` = '$mes_abertura',`ano_abertura` = '$ano_abertura',`hora_abertura` = '$hora_abertura' where `telemarketing`. `codigo` = '$codigo' limit 1 ";
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      ...
      <td>CPF</td>
      <td><? echo $cpf; ?> <input name="cpf" type="hidden" id="cpf" value="<? echo $cpf; ?>">
      </td>
    </tr>
    <tr>
      <td>RG</td>
