...
?>
    ...
    <tr> 
      ...
      <td width="24%"><select name="dia_niver" id="dia_niver">
        ...
        <select name="mes_niver" id="mes_niver">
        ...
        <select name="ano_niver" id="ano_niver">
...
?>
    ...
    <tr>
      <td>Idade</td>
      <td><input name="idade" type="text" id="idade" value="<? echo $idaderetorno; ?>" size="15" maxlength="10"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
...
?>
      ...
      <td><input name="cpf" type="text" id="cpf" value="<? echo $cpfretorno; ?>" size="18" maxlength="14">      </td>
      <td>&nbsp;</td>
    </tr>
...
?>
      ...
      <td><font color="#0000FF">
        <input name="senha_servidor" type="text" id="senha_servidor" value="<? echo $senha_servidorretorno; ?>">
      </font></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
...
?>
        <table width="100%" border="0" align="center">
          <tr>
            <td colspan="10"><div align="center" class="style9">
              <strong>
...
?>
          ...
          <tr>
            <td width="15%">Margem Disponivel 1</td>
          ...
          <tr>
            <td>Observa&ccedil;&otilde;es<strong>
...
?>
    ...
    <tr>
      <td colspan="5"><div align="center"><strong>HISTORICO RESPOSTA PUBLICO / MARGEM</strong></div></td>
    </tr>
    <tr>
      <td colspan="5"><div align="center">
        <textarea name="obs4" cols="100" rows="4" <?  echo "readonly='readonly'"; ?> id="obs4"><?  
