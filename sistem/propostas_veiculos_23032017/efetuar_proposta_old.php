...
<table width="100%" border="1" cellspacing="0" bordercolor="#000000">
    ...
    <tr>
      ...
      <td colspan="4" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000FF" size="4">FICHA PROPOSTA DE FINANCIAMENTO DE VEICULO </font></strong></div></td>
    </tr>

    <tr>

      <td width="14%">Operador</td>

      <td width="32%"><strong><font color="#0000FF"><? echo $operador_atendente; ?>
    ...
    <tr>
      ...
      <td colspan="4" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000FF" size="4">DADOS DO CLIENTE </font></strong></div></td>
    </tr>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF"><? echo $tipo_pessoa; ?></font></strong>        <input name="tipo_pessoa" type="hidden" id="tipo_pessoa" value="<? echo $tipo_pessoa; ?>">       
    ...
    <tr>
      ...
      <td><input name="cpf" type="text" id="cpf" value="<? echo $cpf; ?>" size="11" maxlength="11">

      <strong>Ex: 99999999999 </strong></td>
    ...
    <tr>
      ...
      <td><input name="orgao" type="text" id="orgao2" value="<? echo $orgao_cli; ?>" size="15" maxlength="14"> 
...
?>
    ...
    <tr>
      ...
      <td>anos
        ...
        <input name="meses_residencia" type="text" id="meses_residencia" size="10" maxlength="10"> </td>

      <td>Telefone com DDD </td>

      <td><input name="ddd_tel" type="text" id="ddd_tel" size="4" maxlength="2"> 

      - 

        <input name="telefone" type="text" id="telefone2" value="<? echo $telefone_cli; ?>" size="10" maxlength="9"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="ddd_cel" type="text" id="ddd_cel" size="4" maxlength="2"> 

      - 

        <input name="celular" type="text" id="celular2" value="<? echo $celular_cli; ?>" size="10" maxlength="9"></td>
...
?>
    ...
    <tr>
      ...
      <td colspan="4" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000FF" size="4">INFORMA&Ccedil;&Otilde;ES PROFISSIONAIS</font></strong></div></td>
    </tr>
...
?>
      ...
      <td><input name="ddd_tel_empresa" type="text" id="ddd_tel_empresa" size="4" maxlength="2"> 

      - 

        <input name="telefone_empresa" type="text" id="telefone_empresa" size="10" maxlength="9"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="cnpj" type="text" id="cnpj2" size="50" maxlength="50"></td>

      <td>Telefone contador com DDD </td>

      <td><input name="ddd_tel_contador" type="text" id="ddd_tel_contador2" size="4" maxlength="2">

-

  <input name="tel_contador" type="text" id="tel_contador2" size="10" maxlength="9"></td>
    </tr>

    <tr>

      <td colspan="4" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000FF" size="4">ATIVIDADE/EMPREGO ANTERIOR </font></strong></div></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="ddd_tel_empresa_anterior" type="text" id="ddd_tel_empresa_anterior" size="4" maxlength="2"> 

      - 

        <input name="telefone_empresa_anterior" type="text" id="telefone_empresa_anterior" size="10" maxlength="9"></td>
    ...
    <tr>
      ...
      <td colspan="4" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000FF" size="4">FONTES DE REFER&Ecirc;NCIA </font></strong></div></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="ddd_ref_pessoal" type="text" id="ddd_ref_pessoal" size="4" maxlength="2"> 

      - 

        <input name="tel_ref_pessoal" type="text" id="tel_ref_pessoal" size="10" maxlength="9"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="ddd_ref_pessoal2" type="text" id="ddd_ref_pessoal2" size="4" maxlength="2"> 

      - 

        <input name="tel_ref_pessoal2" type="text" id="tel_ref_pessoal2" size="10" maxlength="9"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="ddd_ref_comercial" type="text" id="ddd_ref_comercial" size="4" maxlength="2"> 

      - 

        <input name="tel_ref_comercial" type="text" id="tel_ref_comercial" size="10" maxlength="9"></td>
    </tr>

    <tr>

      <td colspan="4" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000FF" size="4">REFER&Ecirc;NCIAS FINANCEIRAS </font></strong></div></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="ref_agencia" type="text" id="ref_agencia"> 

      - 

      <input name="digito_agencia" type="text" id="digito_agencia" size="4" maxlength="2"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="ref_conta" type="text" id="ref_conta"> 

      - 

      <input name="digito_conta" type="text" id="digito_conta" size="4" maxlength="2"></td>
...
<input name="ref_conta_desde" type="text" id="ref_conta_desde" size="4" maxlength="2"> 
        ...
        <input name="ano_ref_conta" type="text" id="ano_ref_conta" size="6" maxlength="4"></td>
    ...
    <tr>
      ...
      <td colspan="4" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000FF" size="4">REFER&Ecirc;NCIAS DE BENS </font></strong></div></td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="4" bgcolor="#CCCCCC"><div align="center"><strong><font color="#0000FF" size="4">DADOS DA OPERA&Ccedil;&Atilde;O </font></strong></div></td>
    </tr>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF"><? echo $bem; ?>
      ...
      <td><input name="chassi" type="text" id="chassi" size="40"></td>
    </tr>
    ...
    <tr>
      ...
      <td><input name="ano_modelo" type="text" id="ano_modelo" size="6" maxlength="4"> 

      - 

      <input name="modelo" type="text" id="modelo" size="6" maxlength="4"></td>
    </tr>
    ...
    <tr>
      ...
      <td><font color="#0000FF"><strong>
        ...
        <font color="#0000FF"><? $financiar = bcadd($diferenca,$tac,2);
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF"><? echo $codigo_tabela; ?></font></strong>        <input name="codigo_tabela" type="hidden" id="codigo_tabela" value="<? echo $codigo_tabela; ?>"> 

      Mista <strong><font color="#0000FF"><? echo $mista; ?></font></strong>

      <input name="mista" type="hidden" id="codigo_tabela5" value="<? echo $mista; ?>"></td>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF"><? echo $num_parcelas; ?></font></strong>        <input name="num_parcelas" type="hidden" id="num_parcelas" value="<? echo $num_parcelas; ?>"></td>

      <td>Valor da parcela</td>

      <td><font color="#0000FF"><strong><font color="#0000FF">
      ...
      </font></strong></font>	  <input name="valor_parcelas" type="hidden" id="valor_parcelas" value="<? $prestacao = bcmul($financiar,$coeficiente,2);
    ...
    <tr>
      ...
      <td><input name="trinta" type="checkbox" id="trinta" value="30 DD">
    ...
    <tr> 
      ...
      <td colspan="4"><div align="left"><strong><font color="#0000FF">
        <?
