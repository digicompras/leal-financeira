...
<title>MANUTEN&Ccedil;&Atilde;O DE CLIENTE NO TELEMARKETING</title>
...
$dia_manutencao = date('d');

$mes_manutencao = date('m');

$ano_manutencao = date('Y');

$data_manutencao = "$ano_manutencao-$mes_manutencao-$dia_manutencao";


$hora_manutencao = date('H:i:s');
...
$comando = "update `$linha[1]`.`telemarketing` set `codigo` = '$codigo',`data_manutencao` = '$data_manutencao',`hora_manutencao` = '$hora_manutencao' where `telemarketing`. `codigo` = '$codigo' limit 1 ";
...
$sql = "SELECT * FROM telemarketing where codigo = '$codigo' order by codigo desc limit 1";
...
$dia_fechamento = $linha[25];

$mes_fechamento = $linha[26];

$ano_fechamento = $linha[27];
...
<p align="center"><strong><font color="#0000FF" size="4">Registro de Telemarketing </font><font color="#0000FF"><? echo $codigo; ?></font></strong></p>
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      ...
      <td width="17%"><input name="codigo" type="hidden" id="codigo2" value="<? echo $codigo_telemarketing; ?>">
      Cliente j&aacute; foi trabalhado </td>

      <td width="29%"><? echo $quant_vezes_trabalhado;  ?> vez(es)
      <input name="quant_vezes_trabalhado" type="hidden" id="quant_vezes_trabalhado" value="<? echo $quant_vezes_trabalhado; ?>"></td>

      <td width="16%">N&ordm; de Matr&iacute;cula </td>

      <td width="38%"><strong><font color="#0000FF"><? echo $cod_cliente; ?></font>
...
?>
    ...
    <tr>
      <td>Data Nasc </td>
      <td><input class='class02' name="data_nasc" type="text" id="data_nasc" value="<? echo $data_nasc; ?>" size="15" maxlength="10">
      ...
      <td><select class='class02' name="sexo" id="sexo">
...
?>
    ...
    <tr>
      <td>Celular 1</td>
      <td><input class='class02' name="celular" type="text" id="celular" value="<? echo $celular1; ?>" size="15" maxlength="15"></td>
      <td>Telefone 1</td>
      <td><input class='class02' name="telefone" type="text" id="endereco5" value="<? echo $telefone1; ?>" size="15" maxlength="14"></td>
    </tr>
    <tr>
      <td>Celular 2</td>
...
$dias_atraso = ($hoje-$vencto)*-1;
 ...
 ?>
    ...
    <tr>
      ...
      <td>Ultimo Acesso em <? echo "$dia_fechamento"."/"."$mes_fechamento"."/"."$ano_fechamento "." as $hora_fechamento"; ?></td>
    </tr>
...
<select class='class02' name="mes_ligar" id="mes_ligar">
...
<select class='class02' name="ano_ligar" id="ano_ligar">

  <option selected><? echo $ano_ligar; ?></option>
...
<select class='class02' name="hora_ligar" id="hora_ligar">

  <option><? echo $hora_ligar; ?></option>
  ...
  <option>18:00:00</option>
      ...
      <td>Status 
        ...
        <select class='class02' name="status" id="status">
          ...
          <option>Em manuten&ccedil;&atilde;o</option>
        ...
        <select class='class02' name="proposta" id="proposta">
    ...
    <tr>
      ...
      <td colspan="3"><textarea class='class02' name="obs" cols="100" rows="10" id="obs"><? echo $obs2; ?></textarea></td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="3"><textarea class='class02' name="obs_cli" cols="100" rows="10" readonly="readonly" id="textarea"><?  
