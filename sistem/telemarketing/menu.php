...
$nome_buscar = $_POST['nome'];

if(empty($nome_buscar)){
...
?>
        <input class="class01" type="submit" name="Submit" value="Verificar Agenda">
...
$sql = "select * from clientes where operador_manutencao = '' and quant_vezes_trabalhado = '$quant_vezes_trabalhado' and telemarketing = 'Liberado'  order by codigo asc limit $limite";

}
else{


$sql = "select * from clientes where operador_manutencao = '' and nome like '$nome%' and quant_vezes_trabalhado = '$quant_vezes_trabalhado' and telemarketing = 'Liberado'   order by codigo asc limit $limite";
...
?>
  ...
  <table width="100%"  border="1">
    ...
    <tr>
      ...
      <td><div align="center" class="style2">Ultima manuten&ccedil;&atilde;o / Dias</div></td>
...
$sql = "select * from clientes where quant_vezes_trabalhado = '$quant_vezes_trabalhado' and telemarketing = 'Liberado'  order by codigo asc limit $limite";

}
else{


$sql = "select * from clientes where nome like '%$nome%' and quant_vezes_trabalhado = '$quant_vezes_trabalhado' and telemarketing = 'Liberado'   order by codigo asc limit $limite";
...
$quant_vezes_trabalhado_gravado = $linha[118];

$dias_manutencao = $linha[126];
...
?>
    ...
    <tr >
      ...
      <td width="15%" class="style2"><form name="form1" method="post" action="abrir_telemarketing.php" >
            ...
            <? if($telemarketing<>"Em Manutenção"){ echo "<input class='class01' type='submit' name='Submit42' value='Abrir Telemarketing'>"; } else{ echo "<span class='style3'>EM Manutenção</span>"; } ?>
            </div>
      ...
      <td width="24%" valign="top"><div align="center">
        <form action="../clientes/editar_cliente.php" method="post" name="form3" target="_blank">
          ...
          <input name="cpf" type="hidden" id="cpf" value="<? echo $cpf;  ?>"><br>
          <input class="class01" type="submit" name="button" id="button" value="Consultar">
        </form>
      </div></td>

      <td width="13%" class="style2" valign="top"><div align="center"><span class="<? if($telemarketing=="Em Manuten&ccedil;&atilde;o"){echo"style3"; } else{ echo "style1"; } ?>"><? echo $quant_vezes_trabalhado_gravado; ?></span></div></td>
      <td width="18%" valign="top"><div align="center"><span class="<? if($telemarketing=="Em Manuten&ccedil;&atilde;o"){echo"style3"; } else{ echo "style1"; } ?>"><? echo "$dia_liberado-$mes_liberado-$ano_liberado / $dias_manutencao"; ?></span></div></td>
      ...
      <td width="16%" class="style2" valign="top"><div align="center"><span class="<? if($telemarketing=="Em Manutenção"){echo"style3"; } else{ echo "style1"; } ?>"><?  echo $cidade; ?></span></div></td>

      <td width="14%" class="style2" valign="top"><div align="center"><span class="<? if($telemarketing=="Em Manuten&ccedil;&atilde;o"){echo"style3"; } else{ echo "style1"; } ?>">
