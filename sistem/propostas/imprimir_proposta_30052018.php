...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td width="25%"><div align="center"><img src="../../logo/logotipo.jpg" alt="Leal Financeira" width="141" height="61" /></div></td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="5" background="../../imagens/fundocelulas1.png"><div align="center"><strong>DADOS DA PROPOSTA</strong></div></td>
    </tr>
    <tr>
      <td width="22%"><font size="1">Data da Proposta<br> <strong><? echo $dataproposta; ?></strong></font></td>
      <td><font size="1">Hora proposta<br><strong><? echo $horaproposta; ?></strong></font></td>
      <td width="25%"><font size="1">Tipo da proposta<br> <strong><? echo $tipo_proposta; ?></strong></font></td>
      <td colspan="2"><font size="1">Tabela<br><strong><? echo $tabela; ?></strong></font></td>
    </tr>
    <tr>
      <td><font size="1">Status da proposta<br />
          <strong><? echo $status; ?></strong></font></td>
      <td><font size="1">Status do fisico<br><strong><? echo $status_fisico; ?></strong></font></td>
      <td><font size="1">Data Limite para entrega do f&iacute;sico<br><strong><? echo $prazo_final_formatado; ?></strong></font></td>
      <td colspan="2"><font size="1">Operador / Estabelecimento<br><strong> <? echo "$nome_operador / $estabelecimento_proposta"; ?></strong></font></td>
    </tr>
    <tr>

      <td colspan="5" background="../../imagens/fundocelulas1.png"><div align="center"><strong>DADOS PESSOAIS</strong></div></td>
    </tr>

    <tr>
      <td><p><font size="1">Nome</font><br>
      <font size="1"><strong><? echo $nome; ?></strong></font></p></td>
      <td><font size="1">CPF<br />
          <strong><? echo $cpf; ?></strong></font></td>
      <td><font size="1">RG/<strong>Emiss&atilde;o/</strong>&Oacute;rg&atilde;o<br />
    ...
    <tr>
      <td><font size="1">Pai<br><strong><? echo $pai; ?></strong></font></td>
      <td><font size="1">M&atilde;e<br><strong><? echo $mae; ?></strong></font></td>
      <td><font size="1">Endere&ccedil;o<br><strong><? echo $endereco; ?></strong></font></td>
      <td colspan="2"><font size="1">N&uacute;mero<br><strong><? echo $numero; ?></strong></font></td>
    </tr>
    <tr>
      <td><font size="1">Bairro<br><strong><? echo $bairro; ?></strong></font></td>
      <td><font size="1">Complemento<br><strong><? echo $complemento; ?></strong></font></td>
      <td><font size="1">Cidade<br><strong><? echo $cidade; ?></strong></font></td>
      <td colspan="2"><font size="1">Estado<br><strong><? echo $estado; ?></strong></font></td>
    </tr>
    <tr>
      <td><font size="1">Cep<br><strong><? echo $cep; ?></strong></font></td>
      <td><font size="1">Naturalidade<br><strong><? echo $naturalidade; ?></strong></font></td>
      <td><font size="1">Estado Civil<br> <strong><? echo $estadocivil; ?></strong></font></td>
      <td colspan="2"><font size="1">Como Conheceu a Empresa<br><strong><? echo $resposta; ?></strong></font></td>
    </tr>
    <tr>
      <td><font size="1">Secretaria<br><strong><? echo $secretaria; ?></strong></font></td>
      <td><font size="1">Margem Cart&atilde;o<br><strong><? echo $margemcartao; ?></strong></font></td>
      <td><font size="1">Margem Empr&eacute;stimo<br><strong><? echo $margememprestimo; ?></strong></font></td>
      <td colspan="2"><font size="1">Orienta&ccedil;&atilde;o Sexual<br />
          <strong><? echo $sexo; ?></strong></font></td>
    </tr>
    <tr>
      <td><font size="1">Categoria<br />
        <strong><? echo $categoria; ?></strong></font></td>
      <td><font size="1">Valor Renda<br />
        <strong><? echo $valorrenda; ?></strong></font></td>
      <td><font size="1">E-Mail<br><strong><? echo $email; ?></strong></font></td>
      <td colspan="2"><font size="1">Perfil do cliente <br />
        <strong><? echo $tipo; ?></strong></font></td>
    </tr>
    <tr>
      <td><font size="1">Data Nasc<br><strong><? echo "$dia_niver/$mes_niver/$ano_niver"; ?></strong></font></td>
      <td><font size="1">N&ordm; Benef&iacute;cio 1<br><strong><? echo $num_beneficio; ?></strong></font></td>
      <td><font size="1">N&ordm; Benef&iacute;cio 2 <br><strong><? echo $num_beneficio2; ?></strong></font></td>
      <td colspan="2"><font size="1">N&ordm; Benef&iacute;cio 3 <br><strong><? echo $num_beneficio3; ?></strong></font></td>
    </tr>
    <tr>
      <td><font size="1">N&ordm; Benef&iacute;cio 4 <br><strong><? echo $num_beneficio4; ?></strong></font></td>
      <td><font size="1">Tipo de pagto do Benef&iacute;cio<br><strong><? echo $pagto_beneficio; ?></strong></font></td>
      <td><font size="1">Conjuge<br>
    ...
    <tr>
      ...
      <td colspan="5" background="../../imagens/fundocelulas1.png"><div align="center"><strong>DADOS DA OPERA&Ccedil;&Atilde;O CONSIGNADO</strong></div></td>
    </tr>

    <tr>

      <td><font size="1"><strong>Valor bruto da opera&ccedil;&atilde;o <br><? echo "R$ ".$valor_total; ?></strong></font></td>

      <td><font size="1"><strong>Valor Lid cliente<br> <? echo "R$ ". $valor_liquido_cliente; ?></strong></font></td>

      <td><font size="1">Quant de parcelas<br> <strong><strong><? echo $quant_parc; ?></strong></strong></font></td>
    ...
    <tr>
      ...
      <td><font size="1">Banco a ser Portado<br><strong><? echo $bco_quitacao; ?></strong></font></td>

      <td><font size="1">Banco Opera&ccedil;&atilde;o <br><strong><? echo $bco_operacao; ?></strong></font></td>

      <td><font size="1">Banco Pgto <br><strong><? echo $banco_pagto; ?></strong></font></td>

      <td colspan="2"><font size="1">N&ordm; Banco <br><strong><? echo $num_banco; ?></strong></font></td>
    </tr>

    <tr>
      <td><font size="1">Ag&ecirc;ncia<br><strong><? echo $agencia; ?></strong></font></td>
      <td><font size="1">N&ordm; Conta <br><strong><? echo $conta; ?></strong></font></td>
      <td><font size="1">Tipo Conta<br><strong><? echo " - $tipo_conta"; ?></strong></font></td>
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr>

      <td colspan="5" background="../../imagens/fundocelulas1.png"><div align="center"><strong>REFER&Ecirc;NCIAS</strong></div></td>
    </tr>

    <tr>

      <td><font size="1"><strong>Nome<br><? echo $nome_ref1; ?></strong></font></td>

      <td><font size="1"><strong>Telefone <br><? echo $fone_ref1; ?></strong></font></td>

      <td><font size="1"><strong>Grau de relacionamento<br> <? echo $grau_relacionamento1; ?></strong></font></td>
    ...
    <tr>
      ...
      <td><font size="1"><strong>Nome<br><? echo $nome_ref2; ?></strong></font></td>

      <td><font size="1"><strong>Telefone<br> <? echo $fone_ref2; ?> </strong></font></td>

      <td><font size="1"><strong>Grau de relacionamento<br> <? echo $grau_relacionamento2; ?></strong></font></td>
    ...
    <tr>
      ...
      <td colspan="5" background="../../imagens/fundocelulas1.png"><div align="center"><strong>DADOS PROFISSIONAIS</strong></div></td>
    </tr>

    <tr>

      <td><span class="corpo"><font size="1"><strong><font 
    ...
    <tr>
      ...
      <td width="26%"><span class="corpo"><font size="1"><strong><font 
    ...
    <tr>
      ...
      <td><font size="1"><strong><font face=Verdana>UF<br> </font><font size="1"><strong><? echo $estado_empresa; ?></strong></font></strong></font></td>
      <td><span class="pocospazio"><font size="1"><strong><font face=Verdana>Telefone<br></font><font size="1"><strong><? echo $ddd_tel_empresa; ?> - <? echo $telefone_empresa; ?> </strong></font></strong></font></span></td>
      <td colspan="2"><span class="corpo"><font size="1"><strong>CPT<br><font size="1"><strong><? echo $cpt; ?> </strong></font></strong></font></span></td>
    </tr>
    <tr>
      <td><span class="corpo"><font size="1"><strong>Serie<br><? echo $serie; ?></strong></font></span></td>
      <td><font size="1"><strong><font face=Verdana>Natureza opera&ccedil;&atilde;o<br></font><font size="1"><strong><? echo $natureza_operacao; ?></strong></font></strong></font></td>
      <td><span class="corpo"><font size="1"><strong><font 
    ...
    <tr>
      <td><span class="pocospazio"><font size="1"><strong><font face=Verdana>Atividade principal<br></font><font size="1"><strong><? echo $atividade_principal; ?></strong></font></strong></font></span></td>
      <td><span class="corpo"><font size="1"><strong><font 
            face=Verdana>CNPJ<br><font size="1"><strong><? echo $cnpj; ?></strong></font></font></strong></font></span></td>
      <td><font size="1"><strong><font face=Verdana>Telefone contador<br> </font><font size="1"><strong><? echo $ddd_tel_contador; ?> - <? echo $tel_contador; ?> </strong></font></strong></font></td>
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="5" background="../../imagens/fundocelulas1.png"><div align="center"><strong>DADOS DA OPERA&Ccedil;&Atilde;O(VE&Iacute;CULO)</strong></div></td>
    </tr>
    <tr>
      <td><span class="corpo"><font size="1"><b><font 
    ...
    <tr>
      <td colspan="5"><div align="center"><font size="1">Observa&ccedil;&otilde;es</font><font size="1"><br>
      <strong><? echo $obs; ?></strong></font></div></td>
    </tr>
  </table>
