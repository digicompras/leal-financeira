...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="2"><font size="1"><strong>LOJISTA</strong><br>
      <strong><? echo $lojista; ?></strong></font></td>
    ...
    <tr>
      <td colspan="8"><table border="0" cellpadding="0" width="100%">
        <tr>
          <td colspan="3"><p align="center"><span style="font-size: 14px"><b><? echo "$paragrafo2"; ?></b></span></p></td>
        </tr>
        <tr>
          <td colspan="3"></td>
        </tr>
        <tr>
          <td colspan="3"><p align="center"><span style="font-size: 14px"><b><? echo "$paragrafo3"; ?></b></span></p></td>
        </tr>
        <tr>
          <td colspan="3"></td>
        </tr>
        <tr>
          <td colspan="3"><p align="center"><span style="font-size: 14px"><b><? echo "$paragrafo4"; ?></b></span></p></td>
        </tr>
        <tr>
          <td colspan="3"></td>
        </tr>
        <tr>
          <td colspan="3"><p align="center" style="font-size: 14px"><b><? echo "$paragrafo1"; ?></b></p></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
