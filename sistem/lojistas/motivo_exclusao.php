...
<title>MOTIVO DE EXCLUS&Atilde;O DE FORNECEDOR</title>
...
$sql = "SELECT * FROM lojistas where nfantasia = '$nfantasia' limit 1";
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      ...
      <td colspan="4"><strong>
        ...
        <input name="codigo_excluir" type="hidden" id="codigo_excluir" value="<? echo $codigo; ?>">
    ...
    <tr>
      ...
      <td colspan="3"><strong><font color="#FF0000">Aten&ccedil;&atilde;o!!..Voc&ecirc; est&aacute; prestes a excluir o cadastro do lojista abaixo!</font></strong></td>
    ...
    <tr>
      ...
      <td width="37%" colspan="2"><textarea name="motivo_exclusao" class='class02' cols="50" rows="6" id="motivo_exclusao"></textarea></td>
...
?>
        ...
        <input type="submit" class='class01' name="Submit" value="Excluir"></td><td><div align="right"> </div></td>
