...
?>
    ...
    <tr> 
      ...
      <td width="23%"><input name="data_nasc" type="text" id="data_nasc" value="<? echo $data_nasc; ?>" size="15" maxlength="10">
...
?>
      ...
      <td colspan="2"><textarea name="obs3" cols="70" rows="4" <?  echo "readonly='readonly'"; ?> id="obs3"><? echo $obs_das_margens; ?></textarea></td>
    </tr>
    <tr>
...
?>
                ...
                <tr>
                  <td>Observa&ccedil;&otilde;es<strong>
                    <input name="obs4" type="hidden" id="obs4" value="<? echo $obs; ?>">
                  </strong></td>
...
$reg=0;
    ...
    <tr>
      ...
      <td valign="top"><textarea name="obs_cli" cols="45" rows="7" readonly="readonly" id="obs_cli"><?  
