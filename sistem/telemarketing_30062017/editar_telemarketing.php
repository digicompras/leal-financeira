...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      ...
      <td width="17%">Data Nasc </td>

      <td width="29%"><? echo $data_nasc; ?>
...
<select name="mes_ligar" id="mes_ligar">
...
<select name="ano_ligar" id="ano_ligar">
...
<select name="hora_ligar" id="hora_ligar">
  ...
  <option>18:00:00</option>
      ...
      <td>Status 
        ...
        <select name="proposta" id="proposta">
    ...
    <tr>
      ...
      <td colspan="3"><textarea name="obs" cols="100" rows="10" id="obs"><? echo $obs2; ?></textarea></td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="3"><textarea name="obs_cli" cols="100" rows="10" readonly="readonly" id="textarea"><?  
