...
?>
    ...
    <tr>
      <td width="11%">&nbsp;</td>
      <td width="89%"><strong><font color="#0000FF" size="4">Editar texto da p&aacute;gina inicial!</font></strong></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>
...
?>
    ...
    <tr> 
      ...
      <td><textarea name="texto" cols="50" rows="10" wrap="PHYSICAL" id="texto"><? echo $linha[1]; ?></textarea>
	          <?
if($reg==1){
echo "</tr>";
$reg=0;
