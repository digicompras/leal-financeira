...
?>
      ...
      <td><strong><font color="#0000FF"><? echo date('d-m-Y'); ?></font></strong>
        ...
        <input name="bloqueio_parcial" type="hidden" id="bloqueio_parcial" value="N&atilde;o"></td>
    </tr>
...
Use o formato 00000-000</td>
    ...
    <tr>
      ...
      <td><input name="tempo_almoco" type="text" id="tempo_almoco" value="90" size="4" maxlength="2"> 
      Em minutos</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
