...
?>
  ...
  <?
	...
	$_SESSION['senha'] = $senha;
	?>
<form name="form1" method="post" action="excluir_operador.php">
...
<table width="100%" border="0" cellspacing="4">
    <tr> 
      ...
      <input name="celular2" type="hidden" id="celular" value="<? echo $celular; ?>">
      <input name="email2" type="hidden" id="email2" value="<? echo $email; ?>">
      ...
      <input name="estabelecimento" type="hidden" id="estabelecimento" value="<? echo $estabelecimentor; ?>">
      <input name="cidade_estabelecimento" type="hidden" id="cidade_estabelecimento" value="<? echo $cidade_estabelecimentor; ?>">
      <input name="tel_estabelecimento" type="hidden" id="tel_estabelecimento" value="<? echo $tel_estabelecimentor; ?>">
      <input name="email_estabelecimento" type="hidden" id="email_estabelecimento" value="<? echo $email_estabelecimentor; ?>">
      <input name="funcao" type="hidden" id="funcao" value="<? echo $funcao; ?>"></td>
      <td width="1%">&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><strong><font color="#FF0000">Aten&ccedil;&atilde;o!!..Voc&ecirc; est&aacute; prestes a excluir o cadastro do operador abaixo!</font></strong></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Codigo</td>
      <td colspan="2"><? echo $codigo; ?><strong>
...
$senha = $_SESSION['senha'];
?>
        <input type="submit" name="Submit" value="Excluir cadastro do Operador"> 
