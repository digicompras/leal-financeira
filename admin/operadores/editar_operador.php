...
Bloqueio Parcial <? echo $bloqueio_parcial; ?>
<input type="hidden" name="bloqueio_parcial" id="bloqueio_parcial" value="<? echo $bloqueio_parcial; ?>"></td>
...
?>
    ...
    <tr> 
      ...
      <td><strong><font color="#0000FF"><? echo $funcao; ?></font></strong>        <input name="funcao" type="hidden" id="funcao" value="<? echo $funcao; ?>"></td>
