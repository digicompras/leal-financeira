...
<p>&nbsp;</p>
<p class="style1">Alterar cor da barra lateral esquerda! insira o codigo hexadecimal ex: 0000ff.<br>
   Escolha na tabela abaixo, copie, cole e clique em atualizar
<form action="atualizar_barra_lat_esq.php" method="post" enctype="multipart/form-data" name="form1">
