...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      ...
      <td><strong><font color="#0000FF"><? echo $status_cliente; ?>
        <input name="status_cliente" type="hidden" id="status_cliente" value="<? echo $status_cliente;  ?>">
      </font></strong></td>
    </tr>
...
?>
    ...
    <tr>
      ...
      <td colspan="4"><div align="center">
        <input name="parc1" type="hidden" id="parc1" value="<? echo $parc1; ?>">
        ...
        <input name="saldo7" type="hidden" id="compra14" value="<? echo $saldo7; ?>">
</div>        
      <div align="center"></div>        <div align="center"></div>        <div align="center"></div></td>
    </tr>

    <tr>
      <td colspan="4"><div align="center">Hiscon</div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="4"><div align="center">
        <textarea name="hiscon2" cols="150" rows="10" readonly="readonly" id="hiscon2"><?  
...
?>
        ...
        <table width="100%" border="0" align="center">
          <tr>
            <td colspan="10"><div align="center" class="style9"> <strong>
...
echo "O pedido n&ordm; $num_pedido_ver_margem est&aacute; em an&aacute;lise!";
...
?>
          ...
          <tr>
            <td>Observa&ccedil;&otilde;es<strong>
              <input name="obs3" type="hidden" id="obs3" value="<? echo $obs; ?>">
            </strong></td>
