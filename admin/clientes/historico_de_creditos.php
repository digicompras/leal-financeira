...
$nome = $_POST['nome'];
$nb = $_POST['nb'];
$dia_nasc = $_POST['DiaNascimento'];
$mes_nasc = $_POST['MesNascimento'];
$ano_nasc = $_POST['AnoNascimento'];
$cpf = $_POST['cpf'];
...
var RAIZ_COMS_BIN = "http://www010.dataprev.gov.br/CWS/BIN/imagem91.asp";
...
<input type="text" value="<? echo $nb; ?>" align="left" onkeyup="PularCampo(1);" onkeydown="PularCampo(1);" size="11" maxlength="10" name="nb">
<br>
...
<input type="text" value="<? echo $dia_nasc; ?>" align="left" size="3" onkeyup="PularCampo(2);" onkeydown="PularCampo(2);" maxlength="2" name="DiaNascimento">
<strong>
<font size="5"> / </font>
</strong>
<input type="text" value="<? echo $mes_nasc; ?>" align="left" size="3" onkeyup="PularCampo(3);" onkeydown="PularCampo(3);" maxlength="2" name="MesNascimento">
<strong>
<font size="5"> / </font>
</strong>
<input type="text" value="<? echo $ano_nasc; ?>" align="left" size="5" onkeyup="PularCampo(4);" onkeydown="PularCampo(4);" maxlength="4" name="AnoNascimento">
<br>
...
<input type="text" value="<? echo $nome; ?>" align="left" size="20" maxlength="40" name="nome">
</td>
<td>
<b>
<font size="3" face="verdana">CPF:</font>
</b>
<input type="text" value="<? echo $cpf; ?>" align="left" size="11" maxlength="11" name="cpf">
</td>
</tr>
<tr>
<td colspan="2">
...
<font color="red">
<script>
if (parent.erroconfere != '')
{
document.write (parent.erroconfere + "<br>");
parent.erroconfere = '';
}
</script>
</font>
Por favor, repita ao lado os caracteres exibidos na imagem:
<input type="text" size="4" name="txtImagem">
<br>
Esse procedimento ajuda a evitar que este site seja utilizado por
<br>
consultas automatizadas, o que prejudica o seu funcionamento.
<br>
Se você não estiver conseguindo ver as letras na imagem,
<a href="javascript:Reload ()">clique aqui</a>
.
</b>
</font>
</p>
...
<td>
<div align="left">
<img id="imagem" src="http://www010.dataprev.gov.br/cws/bin/dtpv.asp">
</div>
</td>
</tr>
</tbody>
