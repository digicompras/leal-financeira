...
?>
      ...
      <td width="31%"><select name="status" id="status">
...
<input name="ref_conta_desde" type="text" id="ref_conta_desde" value="<? echo $ref_conta_desde; ?>" size="4" maxlength="2"> 
    ...
    <tr>
      ...
      <td colspan="4"><div align="center"><strong><font color="#0000FF" size="4">DADOS DA OPERA&Ccedil;&Atilde;O - Operando pelo banco </font></strong><strong><font color="#0000FF">
