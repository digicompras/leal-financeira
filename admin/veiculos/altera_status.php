...
//$comando = "update `$linha[1]`.`propostas_veiculos` set `num_proposta` = '$num_proposta',`status` = 'Em Andamento - Analise'
...
<form name="form1" method="post" action="grava_alterar_status.php">
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td colspan="4"><div align="center"><font size="1"><strong><font color="#0000FF">FICHA PROPOSTA <? echo $num_proposta; ?>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF" size="1">

</font><font color="#0000FF">

<select name="status" id="select16">
...
?>
    ...
    <tr>
      ...
      <td colspan="3"><textarea name="parecer_credito" cols="70" rows="7" id="parecer_credito"><? echo $parecer_credito; ?></textarea>

        <strong><font color="#0000FF">

        <input type="submit" name="Submit" value="Salvar Informa&ccedil;&otilde;es">
    ...
    <tr>
      ...
      <td><font size="3"><strong><font color="#0000FF" size="1"><? echo $cpf; ?></font></strong> 
    ...
    <tr>
      ...
      <td><font color="#000000"><? echo $bem; ?></font></td>
    ...
    <tr>
      ...
      <td>      <strong><font color="#0000FF" size="1"><? echo $codigo_tabela; ?> </font></strong><font color="#0000FF" size="1"><font color="#000000">Mista</font></font> <strong><font color="#0000FF" size="1"><? echo $mista; ?></font></strong></td>
    ...
    <tr>
      ...
      </font><font size="1"><strong></strong></font></td>
    </tr>
...
?> 
        ...
        <strong><font color="#0000FF">
        </font><font size="1"><strong><font color="#0000FF">
        <input name="operador_alterou" type="hidden" id="operador3" value="<? echo $nome_op; ?>">
        </font></strong></font><font color="#0000FF">
      ...
      <td><div align="right"><font size="1"><font size="0,5"><font size="0,5"><font size="0,5"><font size="0,5"><font size="0,5"><font size="0,5"><font size="1"><font size="+1"><font size="1"></font></font></font></font></font></font></font></font></font></font> </div></td>
