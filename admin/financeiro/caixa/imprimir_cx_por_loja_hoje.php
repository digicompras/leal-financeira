...
$sql = "SELECT * FROM cx_entradas where datacadastro = '$hoje' and nfantasia = '$nfantasia' order by codigo asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
            ...
            <td width="49%" valign="top"><table width="100%"  border="1">
              ...
              <tr bgcolor="ffffff">
                ...
                <td width="13%"><div align="center" class="style3 style8 style11">Valor</div></td>
                <td><div align="center" class="style11"><strong>Verba</strong></div></td>
                <td><div align="center" class="style10">Aviso</div></td>
...
?>
              ...
              <tr>
                ...
                <td width="18%"><div align="center"><span class="style11"><? echo $modo_pagto; ?></span></div></td>
                <td width="23%">
