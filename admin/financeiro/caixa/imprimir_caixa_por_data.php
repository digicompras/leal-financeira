...
$sql = "select sum(valor) as total_entradas from cx_entradas where datacadastro = '$datacadastro'";
...
?>
              ...
              <tr>
                ...
                <td width="14%"><div align="center">
                  <div align="center" class="style11"><? echo $codigo; ?></div>
                  <span class="style11"></span></div></td>
                <td width="14%"><div align="center">
                  <div align="center" class="style11"><? echo $modo_pagto; ?></div>
                  <span class="style11"></span></div></td>
                <td width="23%">
...
$sql = "select sum(valor) as total_saidas from cx_saidas where datacadastro = '$datacadastro'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
