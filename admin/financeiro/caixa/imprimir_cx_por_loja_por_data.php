...
</span> <span class="style1"><? echo $nome_op; ?></span><span class="style2"> verificando os lan&ccedil;amentos do caixa da loja <? echo $nfantasia; ?> em <? echo $datacadastro; ?><BR>
	      </span></div></td>
        </tr>
</table>
...
$sql = "SELECT * FROM cx_entradas where datacadastro = '$datacadastro' and nfantasia = '$nfantasia' order by codigo asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
          ...
          <tr>
            <td width="49%" valign="top"><table width="100%"  border="1">
              ...
              <tr bgcolor="ffffff">
                <td width="13%"><div align="center" class="style10">Data</div></td>
                <td width="22%"><div align="center" class="style3 style8 style11">Valor </div></td>
...
?>
              <tr>
                ...
                <td width="22%"><div align="center" class="style11"><? echo $categoria_conta_entrada; ?></div></td>
                <td width="16%"><div align="center"><span class="style11"><? echo $codigo; ?></span></div></td>
                <td width="27%">
...
$sql = "select sum(valor) as total_entradas from cx_entradas where datacadastro = '$datacadastro' and nfantasia = '$nfantasia'";
...
?>
            ...
            <td width="49%" valign="top"><table width="100%"  border="1">
              ...
              <tr bgcolor="ffffff">
                <td width="15%"><div align="center" class="style11"><strong>Data</strong></div></td>
...
$sql = "SELECT * FROM cx_saidas where datacadastro = '$datacadastro' and nfantasia = '$nfantasia' order by codigo asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
              ...
              <tr>
                ...
                <td width="20%"><div align="center"><span class="style11"><? echo $categoria_conta_saida; ?></span></div></td>
                <td width="13%"><div align="center"><span class="style11"><? echo $codigo; ?></span></div></td>
                <td width="13%"><div align="center"><span class="style11"><? echo $modo_pagto; ?></span></div></td>
                <td width="23%">
...
$sql = "select sum(valor) as total_saidas from cx_saidas where datacadastro = '$datacadastro' and nfantasia = '$nfantasia'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
