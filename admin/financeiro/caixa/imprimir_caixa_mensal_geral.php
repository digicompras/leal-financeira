...
</span> <span class="style1"><? echo $nome_op; ?></span><span class="style2"> verificando os lan&ccedil;amentos do caixa geral no m&ecirc;s <? echo $mes; ?><BR>
	      </span></div></td>
        </tr>
</table>
...
$sql = "SELECT * FROM cx_entradas where mes = '$mes'  order by codigo asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
          ...
          <tr>
            <td width="49%" valign="top"><table width="100%"  border="1">
              <tr bgcolor="#CCCCCC">
                <td colspan="4"><div align="center"><strong>Entradas</strong></div></td>
              </tr>
              <tr bgcolor="ffffff">
...
?>
              ...
              <tr>
                <td colspan="4"><div align="center"><strong> Total
                          <?
$datacadastro = $_POST['datacadastro'];

$sql = "select sum(valor) as total_entradas from cx_entradas where mes = '$mes'";
...
?>
            ...
            <td width="49%" valign="top"><table width="100%"  border="1">
              <tr bgcolor="#CCCCCC">
                <td colspan="4"><div align="center"><strong>Sa&iacute;das</strong></div></td>
              </tr>
              <tr bgcolor="ffffff">
...
$sql = "SELECT * FROM cx_saidas where mes = '$mes' order by codigo asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
                ...
                <td width="29%"><div align="center"><span class="style11"><? echo $categoria_conta_saida; ?></span></div></td>
                <td width="33%">
...
$sql = "select sum(valor) as total_saidas from cx_saidas where mes = '$mes'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
