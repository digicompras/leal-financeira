...
?>
          ...
          <tr>
            <td width="49%" valign="top"><table width="100%"  border="0">
              ...
              <tr bgcolor="ffffff">
                <td width="11%"><div align="center" class="style10">Data</div></td>
                <td width="17%"><div align="center" class="style3 style8 style11">Valor </div></td>
...
?>
              <tr>
                ...
                <td width="21%"><div align="center" class="style11"><? echo $categoria_conta_entrada; ?></div></td>
              ...
              <tr>
                <td colspan="5"><div align="center"><strong>
                    Total 
                    <?
$sql = "select sum(valor) as total_entradas from cx_entradas where datacadastro = '$hoje'";
...
?>
              ...
              <tr>
                <td colspan="6"><div align="center"><strong>
                    Total 
                    <?
$sql = "select sum(valor) as total_saidas from cx_saidas where datacadastro = '$hoje'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
