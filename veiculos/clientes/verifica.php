...
-->
  ...
  <span class="style1"><? echo $nome; ?></span><? echo " já está cadastrado na $nfantasia!<br><br>Nº de Matrícula do Cliente: $codigo <br><br> Clique em PREENCHER PROPOSTA!";
...
echo "Cliente NÃO cadastrado na $nfantasia!<br><br> Clique em CADASTRAR CLIENTE!";
...
<? } ?>
  ...
  <tr>
	...
	<form action="../propostas_veiculos/informacoes_antecedem_efetuar_proposta.php" method="post" name="form1">
...
?>            
      ...
      <table width="100%"  border="0">
        ...
        <tr>
          ...
          <td width="23%"><div align="center">               <form action="../propostas_veiculos/imprimir_proposta.php" method="post" name="form2" target="_blank">
...
?>
  ...
  <? // printf("<a href='editar_proposta.php?chamar=$linha[0]' >$linha[0]</a>"); ?>
          ...
          <td width="22%"><div align="center"><? echo "R$ $valor_financiar";?>

          </div></td>

          <td><div align="center"><? echo $num_parcelas;?></div></td>

          <td><div align="center"><? echo "R$ $valor_parcelas";?></div></td>

          <td width="19%"><div align="center"><? echo $status;?></div></td>
