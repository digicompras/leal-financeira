...
alert('ATENÇÃO!!!... INFORME O VALOR LIBERADO ASSIM COMO TODOS OS VALORES NO FORMATO 0000.00!');
...
$sql = "SELECT * FROM clientes_veiculos where cpf = '$cpf'";
...
?>
  ...
  <input name="nome_cli" type="hidden" id="nome_cli" value="<? echo $nome_cli; ?>">
...
$sql = "SELECT * FROM estabelecimentos where nfantasia = '$estabelecimento_proposta' and status = '$Ativo'";
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td width="32%"><strong><font color="#0000FF"><? echo $nome_op; ?>
      ...
      <td width="31%"><strong></strong>      <select name="status" id="status">
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">
            ...
            <input name="horaproposta" type="hidden" id="horaproposta2" value="<? echo $hora_atual; ?>">
...
<input name="ref_conta_desde" type="text" id="ref_conta_desde" size="4" maxlength="2"> 
    ...
    <tr>
      ...
      <td><input name="tarifa_cadastro" type="text" id="tarifa_cadastro2" value="<? echo $tac; ?>"></td>
    ...
    <tr>
      ...
      <td><input name="r" type="text" id="r" value="<? echo $r_2; ?>"></td>

      <td><strong><font color="#FF0000">Valor Liberado</font></strong></td>
    ...
    <tr>
      ...
      <td><input name="num_parcelas" type="text" id="num_parcelas" value="<? echo $num_parcelas; ?>"></td>

      <td>Valor da parcela</td>

      <td><input name="valor_parcelas" type="text" id="valor_parcelas" value="<? $prestacao = bcmul($financiar,$coeficiente,2);
    ...
    <tr>
      ...
      <td><strong>
        ...
        <font color="#0000FF">
        <input name="pagto_serv_terc" type="text" id="pagto_serv_terc" value="<? echo $serv_terceiros; ?>">
      </font>      </strong></td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="3"><textarea name="obs" cols="100" rows="5" id="obs"></textarea></td>
    </tr>
