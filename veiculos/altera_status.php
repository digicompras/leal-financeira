...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td colspan="3"><textarea name="parecer_credito" cols="70" rows="7" id="parecer_credito"></textarea>
...
?> 
        ...
        <input name="horaalteracao" type="hidden" id="horaproposta" value="<? echo $hora_atual; ?>">
