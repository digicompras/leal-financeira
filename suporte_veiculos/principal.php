...
<table width="100%"  border="0">
  ...
  <tr>
    ...
    <td colspan="3"><form action="principal.php" method="post" name="form5">
...
?>
        ...
        CPF proponente
          ...
          <input name="cpf2" type="text" id="num_proposta22" size="15">
...
$sql = "SELECT * FROM propostas_veiculos where cpf = '$cpf2' order by num_proposta desc";
...
<table width="100%"  border="0">
  ...
  <tr bgcolor="#<? echo "008080"; ?>">
    ...
    <td width="10%"><div align="center"><font size="2">Quant  parcelas </font></div></td>

    <td width="11%"><div align="center"><font size="2">Valor parcelas </font></div></td>
...
?>
        ...
        <input name="num_proposta" type="hidden" id="num_proposta3" value="<? echo $linha[0]; ?>">
...
?>
    ...
    <td width="11%"><div align="center"><font size="2"><? echo "R$ ".$valor_financiar2;?> </font></div></td>
...
<table width="100%"  border="0">
  ...
  <tr bgcolor="#<? echo "008080"; ?>">
    ...
    <td width="9%"><div align="center"><font size="2">Quant parcelas </font></div></td>

    <td width="9%"><div align="center"><font size="2">Valor parcelas </font></div></td>
...
$sql = "SELECT * FROM propostas_veiculos order by num_proposta desc";
...
?>
          ...
          <input type="submit" name="Submit34" value="Editar Proposta">
...
?>
    ...
    <td width="12%"><div align="center"><font size="2"><? echo "R$ ".$valor_financiar;?> </font></div></td>

    <td><div align="center"><font size="2"><? echo $num_parcelas;?> </font></div></td>

    <td><div align="center"><font size="2"><? echo "R$ ".$valor_parcelas;?> </font></div></td>

    <td width="17%"><div align="center"><font size="2"><? echo $status;?> </font></div></td>
