...
<table width="100%" border="0" cellspacing="4">
    <tr> 
      <td colspan="2"><strong>Ol&aacute;! Seja bem vindo<br> </strong><strong><font color="#0000FF"><? echo $nome_operador; ?> 
        </font></strong><strong><font color="#0000FF">      </font></strong><strong></strong></td>
      <td width="22%"><strong>Hoje &eacute;: <font color="#0000FF"> <? echo $data; ?></font><font color="#0000FF"> </font></strong></td>
...
?>
          ...
          <? if($reg==0){echo "<input type='submit' name='Submit9' value='Entrada Manh&atilde;'>"; } ?>
          </font></strong>
        </form>
